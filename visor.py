...
from visor_ui import (
    ACENTO, CARNIVORO, COLOR_ESPECIE, ELEVADA, FONDO, HERBIVORO, LINEA,
    MUTED, PLANTA, SUPERFICIE, TINTA, TINTA2,
...
class App:
    ...
    def dibujar_navegacion(self):
        ...
        pygame.draw.line(self.pantalla, LINEA, (0, CABECERA),
                         (ANCHO, CABECERA))
    ...
    def _construir_config(self):
        ...
        self.d_lado = Deslizador((col1, y, ancho, 40),
                                 "Lado de la cuadricula", 16, 256, 64)
        self.d_ticks = Deslizador((col1, y + salto, ancho, 40), "Ticks",
                                  20, 600, 300, paso=10)
        self.d_semilla = Deslizador((col1, y + salto * 2, ancho, 40),
                                    "Semilla", 1, 99999, 20260809 % 99999)
    ...
    def dibujar_config(self):
        ...
        if total > cap:
            ...
            texto(self.pantalla, self.f_normal, self.mensaje, MARGEN, y,
                  TINTA2)
        else:
    ...
    def dibujar_visor(self):
        ...
        for etiqueta, valor, color in (
            ...
            pygame.draw.rect(self.pantalla, color,
                             ...
                             border_radius=3)
            texto(self.pantalla, self.f_normal, etiqueta, panel_x + 33,
                  y + 19, TINTA2)
        ...
        texto(self.pantalla, self.f_chico, "Poblaciones", gr.x + 14,
              gr.y + 10, TINTA2)
        ...
        for etiqueta, valor in filas_info:
            texto(self.pantalla, self.f_chico, etiqueta, info.x + 14, yy,
                  MUTED)
        ...
        self.r_scrub = pygame.Rect(MARGEN, barra_y + 64,
                                   ANCHO - MARGEN * 2, 14)
    ...
    def dibujar_herramientas(self):
        ...
        graf = pygame.Rect(consola.right + MARGEN, y, 380, ALTO - y - MARGEN)
